import 'package:amankrmj_portfolio/utils/path_ex.dart';
import 'package:flutter/material.dart';

class FooterPath extends StatelessWidget {
  const FooterPath({super.key, required this.color, required this.animation});
  ...
  Widget build(BuildContext context) {
    return CustomPaint(painter: AnimatedPathPainter(animation, color: color));
  }
}
