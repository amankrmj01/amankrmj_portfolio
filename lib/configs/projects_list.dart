...
List<ProjectInfo> projects = [
  ...
  ProjectInfo(
    ...
    largeDescription:
        '• Utilizes weather APIs to fetch real-time data.\n'
  ...
  ProjectInfo(
    ...
    largeDescription:
        '• Built with Flutter Web for a seamless, cross-platform experience.\n'
  ...
  ProjectInfo(
    ...
    description: 'An app to track daily expenses and visualize spending.',
    largeDescription:
        '• Allows users to add, edit, and categorize expenses.\n'
  ...
  ProjectInfo(
    name: 'Recipe Finder',
    description:
        'A mobile app to discover and save recipes from around the world.',
    largeDescription:
