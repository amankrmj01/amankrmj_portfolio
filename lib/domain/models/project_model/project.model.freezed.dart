...
mixin _$ProjectModel {
 ...
 String get name; String get description; String get url; List<String> get images; String get largeDescription; String get type;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,description,url,const DeepCollectionEquality().hash(images),largeDescription,type);

@override
String toString() {
  return 'ProjectModel(name: $name, description: $description, url: $url, images: $images, largeDescription: $largeDescription, type: $type)';
}
...
@useResult
$Res call({
 String name, String description, String url, List<String> images, String largeDescription, String type
});
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? url = null,Object? images = null,Object? largeDescription = null,Object? type = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String description,  String url,  List<String> images,  String largeDescription,  String type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.name,_that.description,_that.url,_that.images,_that.largeDescription,_that.type);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String description,  String url,  List<String> images,  String largeDescription,  String type)  $default,) {final _that = this;
switch (_that) {
case _ProjectModel():
return $default(_that.name,_that.description,_that.url,_that.images,_that.largeDescription,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String description,  String url,  List<String> images,  String largeDescription,  String type)?  $default,) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.name,_that.description,_that.url,_that.images,_that.largeDescription,_that.type);case _:
  return null;
...
class _ProjectModel implements ProjectModel {
  const _ProjectModel({required this.name, required this.description, required this.url, required final  List<String> images, required this.largeDescription, required this.type}): _images = images;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,description,url,const DeepCollectionEquality().hash(_images),largeDescription,type);
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? url = null,Object? images = null,Object? largeDescription = null,Object? type = null,}) {
